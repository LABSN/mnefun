...
DOCMODULES = ['mnefun', 'matplotlib', 'numpy', 'scipy']
...
def generate_file_rst(fname, target_dir, src_dir, root_dir, plot_gallery):
    ...
    Returns the set of mnefun functions/classes imported in the example.
    """
    ...
    if not os.path.exists(thumb_file):
        ...
        make_thumbnail('source/_images/ilabs.png', thumb_file, 180, 175)
...
def embed_code_links(app, exception):
    ...
    doc_resolvers = {}
    doc_resolvers['mnefun'] = SphinxDocLinkResolver(app.builder.outdir,
                                                    relative=True)
